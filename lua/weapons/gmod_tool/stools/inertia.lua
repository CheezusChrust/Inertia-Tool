...
if CLIENT then
    ...
    hook.Add("HUDPaint", "Inertia::HUD", function()
        ...
        local str = "Current: " .. matrixToString(ply:GetNWVectorPrecise("inertia"), Vector())
        local str2 = "Default: " .. matrixToString(ent:GetNWVectorPrecise("defaultinertia") * ply:GetNWFloat("inertiamass"), Vector())
